...
sleep 10
xterm -e "cd ${path_catkin_ws}; source devel/setup.bash; roslaunch turtlebot_rviz_launchers view_navigation.launch rviz_config_file:="/home/workspace/catkin_ws/src/rvizConfig/navigation1.rviz"" &
sleep 15
